...
class ConditionDistribution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets condition
     *
     * @param string|null $condition The text describing the condition of the item, such as <i>New</i> or <i>Used</i>. For a list of condition names, refer to <a href=\"/devzone/finding/callref/enums/conditionIdList.html \" target=\"_blank\">Item Condition IDs and Names</a>.
     *
     * @return self
     */
     ...
     * Sets condition_id
     *
     * @param string|null $condition_id The identifier of the condition. For example, <code>1000</code> is the identifier for <code>NEW</code>.
     *
     * @return self
     */
