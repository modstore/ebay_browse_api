...
class ResponsiblePerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets address_line1
     *
     * @param string|null $address_line1 The first line of the Responsible Person's street address.
     *
     * @return self
     */
     ...
     * Sets address_line2
     *
     * @param string|null $address_line2 The second line of the Responsible Person's address. This field is not always used, but can be used for secondary address information such as 'Suite Number' or 'Apt Number'.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city of the Responsible Person's street address.
     *
     * @return self
     */
     ...
     * Sets company_name
     *
     * @param string|null $company_name The name of the the Responsible Person or entity.
     *
     * @return self
     */
     ...
     * Sets country_name
     *
     * @param string|null $country_name The country name of the Responsible Person's street address.
     *
     * @return self
     */
     ...
     * Sets county
     *
     * @param string|null $county The county of the Responsible Person's street address.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email The email of the Responsible Person's street address.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone The phone number of the Responsible Person's street address.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code of the Responsible Person's street address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $state_or_province The state or province of the Responsible Person's street address.
     *
     * @return self
     */
     ...
     * Sets types
     *
     * @param string[]|null $types The type(s) associated with the Responsible Person or entity.
     *
     * @return self
     */
