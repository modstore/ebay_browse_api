...
class ItemSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'categories' => '\Modstore\EbayBrowseApi\Model\Category[]',
        'compatibility_match' => 'string',
        'compatibility_properties' => '\Modstore\EbayBrowseApi\Model\CompatibilityProperty[]',
        'condition' => 'string',
        'condition_id' => 'string',
        'current_bid_price' => '\Modstore\EbayBrowseApi\Model\ConvertedAmount',
        'distance_from_pickup_location' => '\Modstore\EbayBrowseApi\Model\TargetLocation',
        ...
        'item_href' => 'string',
        'item_id' => 'string',
        'item_location' => '\Modstore\EbayBrowseApi\Model\ItemLocationImpl',
        'item_web_url' => 'string',
        'leaf_category_ids' => 'string[]',
        'legacy_item_id' => 'string',
        'listing_marketplace_id' => 'string',
        'marketing_price' => '\Modstore\EbayBrowseApi\Model\MarketingPrice',
        'pickup_options' => '\Modstore\EbayBrowseApi\Model\PickupOptionSummary[]',
        ...
        'seller' => '\Modstore\EbayBrowseApi\Model\Seller',
        'shipping_options' => '\Modstore\EbayBrowseApi\Model\ShippingOptionSummary[]',
        'short_description' => 'string',
        'thumbnail_images' => '\Modstore\EbayBrowseApi\Model\Image[]',
        'title' => 'string',
    ...
    */
     ...
     *
     * @param \Modstore\EbayBrowseApi\Model\Image[]|null $additional_images An array of containers with the URLs for the images that are in addition to the primary image. The primary image is returned in the <code>image.imageUrl</code> field.
     *
     * @return self
     */
     ...
     * Gets categories
     *
     * @return \Modstore\EbayBrowseApi\Model\Category[]|null
     */
     ...
     * Sets categories
     *
     * @param \Modstore\EbayBrowseApi\Model\Category[]|null $categories This array returns the name and ID of each category associated with the item, including top level, branch, and leaf categories.
     *
     * @return self
     */
     ...
     *
     * @return \Modstore\EbayBrowseApi\Model\CompatibilityProperty[]|null
     */
     ...
     * Sets condition
     *
     * @param string|null $condition The text describing the condition of the item, such as <b>New</b> or <b>Used</b>. For a list of condition names, refer to <a href=\"/devzone/finding/callref/enums/conditionIdList.html \" target=\"_blank\">Item Condition IDs and Names</a>.
     *
     * @return self
     */
     ...
     * Sets condition_id
     *
     * @param string|null $condition_id The identifier of the condition of the item. For example, <code>1000</code> is the identifier for <code>NEW</code>. For a list of condition names and IDs, refer to <a href=\"/devzone/finding/callref/enums/conditionIdList.html \" target=\"_blank\">Item Condition IDs and Names</a>.
     *
     * @return self
     */
     ...
     *
     * @return \Modstore\EbayBrowseApi\Model\TargetLocation|null
     */
     ...
     *
     * @param \Modstore\EbayBrowseApi\Model\TargetLocation|null $distance_from_pickup_location distance_from_pickup_location
     *
     * @return self
     */
     ...
     * Gets item_location
     *
     * @return \Modstore\EbayBrowseApi\Model\ItemLocationImpl|null
     */
     ...
     * Sets item_location
     *
     * @param \Modstore\EbayBrowseApi\Model\ItemLocationImpl|null $item_location item_location
     *
     * @return self
     */
     ...
     * Gets pickup_options
     *
     * @return \Modstore\EbayBrowseApi\Model\PickupOptionSummary[]|null
     */
     ...
     * Sets pickup_options
     *
     * @param \Modstore\EbayBrowseApi\Model\PickupOptionSummary[]|null $pickup_options This container returns the local pickup options available to the buyer. This container is returned only if the user is searching for local pickup items and set the local pickup filters in the method request.
     *
     * @return self
     */
     ...
     * Gets seller
     *
     * @return \Modstore\EbayBrowseApi\Model\Seller|null
     */
     ...
     * Sets seller
     *
     * @param \Modstore\EbayBrowseApi\Model\Seller|null $seller seller
     *
     * @return self
     */
     ...
     *
     * @return \Modstore\EbayBrowseApi\Model\ShippingOptionSummary[]|null
     */
     ...
     *
     * @param \Modstore\EbayBrowseApi\Model\ShippingOptionSummary[]|null $shipping_options This container returns the shipping options available to ship the item.
     *
     * @return self
     */
     ...
     *
     * @param \Modstore\EbayBrowseApi\Model\Image[]|null $thumbnail_images An array of thumbnail images for the item.
     *
     * @return self
     */
