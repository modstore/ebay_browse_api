...
class AddonService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'selection' => 'string',
        'service_fee' => '\Modstore\EbayBrowseApi\Model\ConvertedAmount',
        'service_id' => 'string',
        'service_type' => 'string'
    ];
    ...
    */
     ...
     * Sets service_fee
     *
     * @param \Modstore\EbayBrowseApi\Model\ConvertedAmount|null $service_fee service_fee
     *
     * @return self
     */
     ...
     * Sets service_type
     *
     * @param string|null $service_type The type of add-on service, such as <code>AUTHENTICITY_GUARANTEE</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/gct:AddonServiceTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
