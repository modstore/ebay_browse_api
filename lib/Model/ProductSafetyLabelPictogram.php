...
class ProductSafetyLabelPictogram implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductSafetyLabelPictogram';
    ...
    */
     ...
     *
     * @param string|null $pictogram_description The description of the safety label pictogram.
     *
     * @return self
     */
     ...
     * Sets pictogram_id
     *
     * @param string|null $pictogram_id The identifier of the safety label pictogram.
     *
     * @return self
     */
     ...
     * Sets pictogram_url
     *
     * @param string|null $pictogram_url The URL of the safety label pictogram.
     *
     * @return self
     */
