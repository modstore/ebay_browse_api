...
class ProductSafetyLabelStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductSafetyLabelStatement';
    ...
    */
     ...
     *
     * @param string|null $statement_description A description of the nature of the product safety label statement.
     *
     * @return self
     */
     ...
     * Sets statement_id
     *
     * @param string|null $statement_id The identifier of the product safety label statement.
     *
     * @return self
     */
