...
class ItemLocationImpl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets city
     *
     * @param string|null $city The city in which the item is located.<br><br><b>Restriction:</b> This field is populated in the <code>search</code> method response <i>only</i> when <code>fieldgroups</code> = <code>EXTENDED</code>.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code (or zip code in US) where the item is located. Sellers set a postal code for items when they are listed. The postal code is used for calculating proximity searches. It is anonymized when returned in <code>itemLocation.postalCode</code> via the API.
     *
     * @return self
     */
