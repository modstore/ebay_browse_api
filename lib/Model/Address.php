...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets address_line1
     *
     * @param string|null $address_line1 The first line of the street address.<br><br><span class=\"tablenote\"><b>Note:</b> This is conditionally returned in the <code>itemLocation</code> field.</span>
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code (or zip code in US) code of the address. Sellers set a postal code (or zip code in US) for items when they are listed. The postal code is used for calculating proximity searches. It is anonymized when returned in <code>itemLocation.postalCode</code> via the API.
     *
     * @return self
     */
     ...
     *
     * @param string|null $state_or_province The state or province of the address.<br><br><span class=\"tablenote\"><b>Note:</b> This is conditionally returned in the <code>itemLocation</code> field.</span>
     *
     * @return self
     */
